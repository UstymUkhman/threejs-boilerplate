(module
 ...
 (data (i32.const 176) "\02\00\00\00\01\00\00\00\01\00\00\00\02\00\00\00v")
 ...
 (func $src/assembly/index/version (; 18 ;) (param $0 i32) (result i32)
  local.get $0
  call $~lib/string/String#concat
 )
 (func $src/assembly/index/print (; 19 ;) (param $0 i32)
  local.get $0
  call $src/assembly/module/log
 )
 (func $src/assembly/index/add (; 20 ;) (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  local.get $1
  i32.add
 )
 (func $src/assembly/index/fib (; 21 ;) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $src/assembly/index/fact (; 22 ;) (param $0 i32) (result i32)
  local.get $0
  i32.const 0
  i32.lt_s
  if (result i32)
