(module
 ...
 (import "module" "log" (func $src/assembly/module/log (param i32)))
 (memory $0 1)
 ...
 (export "fib" (func $src/assembly/index/fib))
 (export "fact" (func $src/assembly/index/fact))
 ...
 (func $src/assembly/module/getVersion (; 20 ;) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  local.get $0
  call $~lib/rt/pure/__retain
 ...
 (func $src/assembly/index/version (; 21 ;) (param $0 i32) (result i32)
  (local $1 i32)
  local.get $0
  call $~lib/rt/pure/__retain
  local.set $0
  local.get $0
  call $src/assembly/module/getVersion
  local.set $1
  local.get $0
  call $~lib/rt/pure/__release
  local.get $1
 )
 (func $src/assembly/module/consoleLog (; 22 ;) (param $0 i32)
  local.get $0
  call $~lib/rt/pure/__retain
  local.set $0
  local.get $0
  call $src/assembly/module/log
  local.get $0
  call $~lib/rt/pure/__release
 )
 (func $src/assembly/index/print (; 23 ;) (param $0 i32)
  local.get $0
  call $~lib/rt/pure/__retain
  local.set $0
  local.get $0
  call $src/assembly/module/consoleLog
  local.get $0
  call $~lib/rt/pure/__release
 )
 (func $src/assembly/index/add (; 24 ;) (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  local.get $1
  i32.add
 )
 (func $src/assembly/index/fib (; 25 ;) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $src/assembly/index/fact (; 26 ;) (param $0 i32) (result i32)
  local.get $0
  i32.const 0
  i32.lt_s
  if
