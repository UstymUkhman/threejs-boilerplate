...
#include <output_fragment>`,Nt;(s=>{s.blend=(e,t,i=.5)=>{const n=s.hexToRGB(e),r=s.hexToRGB(t);return`#${(4294967296+Math.round((r.r-n.r)*i+n.r)*65536+Math.round((r.g-n.g)*i+n.g)*256+Math.round((r.b-n.b)*i+n.b)).toString(16).slice(3)}`.toUpperCase()},s.getClass=e=>new Le(e),s.rgbToHEX=e=>`#${((1<<24)+(e.r<<16)+(e.g<<8)+e.b).toString(16).slice(1)}`.toUpperCase(),s.hexToRGB=e=>{const t=parseInt(e.slice(1),16);return{r:t>>16&255,g:t>>8&255,b:t&255}},s.BLACK=0,s.FOG=15263976,s.WHITE=16777215})(Nt||(Nt={}));var Ke;(s=>{s.Background=Nt.FOG,s.Fog={color:Nt.FOG,visible:!0,near:100,far:250},s.Camera={position:new P(0,25,-50),target:new P(0,0,25),fov:50,near:.1,far:500},s.Lights={ambient:{color:Nt.WHITE,intensity:.25},directional:{position:new P(-15,25,50),rotation:new mn(.785,0,.25),color:Nt.WHITE,intensity:1,shadow:{mapSize:new De(1024,1024),cast:!0,camera:{bottom:-25,right:25,left:-25,near:1,far:50,top:15}},helper:{color:Nt.WHITE,visible:!0,size:10}}},s.Ground={color:Nt.WHITE,size:500,cell:26}})(Ke||(Ke={}));class qp extends kp{cellSize={value:Ke.Ground.cell};constructor(e={}){super(e),this.setValues(e)}updateDefaultVertexShader(e){e.vertexShader=`${Hp}
