(module
 ...
 (import "index" "log" (func $src/assembly/index/log (param i32)))
 ...
 (data (i32.const 1184) "\02\00\00\00\01\00\00\00\01\00\00\00\02\00\00\00v")
 (data (i32.const 1216) "\08\00\00\00\01\00\00\00\01\00\00\00\08\00\00\00n\00u\00l\00l")
 (data (i32.const 1252) "\01\00\00\00\01")
 (data (i32.const 1264) "\18\00\00\00\01\00\00\00\01\00\00\00\18\00\00\00~\00l\00i\00b\00/\00m\00a\00t\00h\00.\00t\00s")
 (data (i32.const 1312) "\0b\00\00\00 \00\00\00\00\00\00\00 \00\00\00\00\00\00\00 \00\00\00\00\00\00\00a\08\00\00\02\00\00\00a\00\00\00\02\00\00\00\a1\08\00\00\02\00\00\00\a1\00\00\00\02\00\00\00!\t\00\00\02\00\00\00!\01\00\00\02\00\00\00!\19\00\00\02\00\00\00!\1a\00\00\02")
 ...
 (export "version" (func $src/assembly/index/version))
 (export "print" (func $src/assembly/index/print))
 (export "clamp" (func $src/assembly/number/clamp@varargs))
 (export "mix" (func $src/assembly/number/mix))
 (export "fibonacci" (func $src/assembly/number/fibonacci))
 (export "smoothstep" (func $src/assembly/number/smoothstep))
 (export "map" (func $src/assembly/number/map))
 (export "lerp" (func $src/assembly/number/lerp))
 (export "factorial" (func $src/assembly/number/factorial))
 (export "random" (func $src/assembly/number/random))
 ...
 (func $src/assembly/index/version (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $src/assembly/index/print (param $0 i32)
  local.get $0
  call $~lib/rt/pure/__retain
  local.tee $0
  call $src/assembly/index/log
  local.get $0
  call $~lib/rt/pure/__release
 )
 (func $src/assembly/number/clamp (param $0 i32) (param $1 i32) (param $2 i32) (result f64)
  local.get $1
  f64.convert_i32_s
  local.get $0
  f64.convert_i32_s
 ...
 (func $src/assembly/number/mix (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  local.get $0
  i32.const 1
  local.get $2
  i32.sub
 ...
 (func $src/assembly/number/fibonacci (param $0 i32) (result i32)
  local.get $0
  i32.const 2
  i32.lt_s
  if (result i32)
   ...
   i32.sub
   local.tee $0
   call $src/assembly/number/fibonacci
   local.get $0
   i32.const 1
   i32.sub
   call $src/assembly/number/fibonacci
 ...
 (func $src/assembly/number/smoothstep (param $0 i32) (param $1 i32) (param $2 i32) (result f64)
  f64.const 0
  f64.const 1
  local.get $2
  local.get $0
 ...
 (func $src/assembly/number/map (param $0 i32) (param $1 i32) (param $2 i32) (result f64)
  local.get $0
  local.get $1
  i32.sub
  local.get $2
  ...
  i32.const 0
  i32.const 1
  call $src/assembly/number/clamp
 )
 (func $src/assembly/number/lerp (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  local.get $0
  local.get $2
  local.get $1
  local.get $0
 ...
 (func $src/assembly/number/factorial (param $0 i32) (result i32)
  local.get $0
  i32.const 0
  i32.gt_s
  if (result i32)
   ...
   i32.const 1
   i32.sub
   call $src/assembly/number/factorial
   local.get $0
   i32.mul
  else
   i32.const -1
 ...
 (func $src/assembly/number/random (param $0 i32) (param $1 i32) (result f64)
   ...
   block $__inlined_func$~lib/rt/__visit_members
    block $switch$1$default
     block $switch$1$case$4
      ...
      i32.add
      i32.load
      br_table $__inlined_func$~lib/rt/__visit_members $__inlined_func$~lib/rt/__visit_members $switch$1$case$4 $switch$1$case$4 $switch$1$case$4 $switch$1$case$4 $switch$1$case$4 $switch$1$case$4 $switch$1$case$4 $switch$1$case$4 $switch$1$case$4 $switch$1$default
     end
     local.get $0
     i32.load offset=16
     local.tee $1
 ...
 (func $src/assembly/number/clamp@varargs (param $0 i32) (param $1 i32) (param $2 i32) (result f64)
  block $2of2
   block $1of2
    block $0of2
     block $outOfRange
